...
void cedar::dev::ComponentParameter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ComponentParameter::*)(const std::string & , const std::string & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ComponentParameter::reselect)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject cedar::dev::ComponentParameter::staticMetaObject = { {
    &cedar::aux::Parameter::staticMetaObject,
    qt_meta_stringdata_cedar__dev__ComponentParameter.data,
    qt_meta_data_cedar__dev__ComponentParameter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
