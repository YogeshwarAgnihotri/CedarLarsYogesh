...
void cedar::dev::gui::KinematicChainMonitorWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<KinematicChainMonitorWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject cedar::dev::gui::KinematicChainMonitorWidget::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_cedar__dev__gui__KinematicChainMonitorWidget.data,
    qt_meta_data_cedar__dev__gui__KinematicChainMonitorWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
