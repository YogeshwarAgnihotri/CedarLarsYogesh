...
QT_INIT_METAOBJECT const QMetaObject cedar::dyn::scripts::ExecuteFunctionOnSteps::staticMetaObject = { {
    &cedar::proc::CppScript::staticMetaObject,
    qt_meta_stringdata_cedar__dyn__scripts__ExecuteFunctionOnSteps.data,
    qt_meta_data_cedar__dyn__scripts__ExecuteFunctionOnSteps,
    qt_static_metacall,
    nullptr,
    nullptr
} };
