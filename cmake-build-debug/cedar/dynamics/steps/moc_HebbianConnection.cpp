...
QT_MOC_LITERAL(3, 65, 20), // "updateInputDimension"
QT_MOC_LITERAL(4, 86, 12), // "resetWeights"
QT_MOC_LITERAL(5, 99, 15), // "toggleUseReward"
QT_MOC_LITERAL(6, 115, 22) // "toggleUseManualWeights"

    },
    "cedar::dyn::steps::HebbianConnection\0"
    "updateAssociationDimension\0\0"
    "updateInputDimension\0resetWeights\0"
...
void cedar::dyn::steps::HebbianConnection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<HebbianConnection *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updateAssociationDimension(); break;
        case 1: _t->updateInputDimension(); break;
        case 2: _t->resetWeights(); break;
        case 3: _t->toggleUseReward(); break;
        case 4: _t->toggleUseManualWeights(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
QT_INIT_METAOBJECT const QMetaObject cedar::dyn::steps::HebbianConnection::staticMetaObject = { {
    &cedar::dyn::Dynamics::staticMetaObject,
    qt_meta_stringdata_cedar__dyn__steps__HebbianConnection.data,
    qt_meta_data_cedar__dyn__steps__HebbianConnection,
    qt_static_metacall,
    nullptr,
    nullptr
} };
