...
void cedar::dyn::SpaceToRateCode::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SpaceToRateCode *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject cedar::dyn::SpaceToRateCode::staticMetaObject = { {
    &cedar::dyn::Dynamics::staticMetaObject,
    qt_meta_stringdata_cedar__dyn__SpaceToRateCode.data,
    qt_meta_data_cedar__dyn__SpaceToRateCode,
    qt_static_metacall,
    nullptr,
    nullptr
} };
