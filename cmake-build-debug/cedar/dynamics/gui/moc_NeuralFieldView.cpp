...
void cedar::dyn::gui::NeuralFieldView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<NeuralFieldView *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject cedar::dyn::gui::NeuralFieldView::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_cedar__dyn__gui__NeuralFieldView.data,
    qt_meta_data_cedar__dyn__gui__NeuralFieldView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
