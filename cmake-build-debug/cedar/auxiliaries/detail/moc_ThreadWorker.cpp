...
void cedar::aux::detail::ThreadWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ThreadWorker::finishedWorking)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject cedar::aux::detail::ThreadWorker::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_cedar__aux__detail__ThreadWorker.data,
    qt_meta_data_cedar__aux__detail__ThreadWorker,
    qt_static_metacall,
    nullptr,
    nullptr
} };
