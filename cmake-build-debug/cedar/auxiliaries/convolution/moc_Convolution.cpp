...
QT_MOC_LITERAL(3, 52, 21), // "combinedKernelUpdated"
QT_MOC_LITERAL(4, 74, 21), // "selectedEngineChanged"
QT_MOC_LITERAL(5, 96, 20) // "updateCombinedKernel"

    },
    "cedar::aux::conv::Convolution\0"
    "configurationChanged\0\0combinedKernelUpdated\0"
    "selectedEngineChanged\0updateCombinedKernel"
};
...
void cedar::aux::conv::Convolution::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Convolution *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->configurationChanged(); break;
        case 1: _t->combinedKernelUpdated(); break;
        case 2: _t->selectedEngineChanged(); break;
        case 3: _t->updateCombinedKernel(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Convolution::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Convolution::configurationChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Convolution::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Convolution::combinedKernelUpdated)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject cedar::aux::conv::Convolution::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_cedar__aux__conv__Convolution.data,
    qt_meta_data_cedar__aux__conv__Convolution,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 1
void cedar::aux::conv::Convolution::combinedKernelUpdated()
{
