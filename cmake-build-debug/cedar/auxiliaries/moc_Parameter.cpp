...
void cedar::aux::Parameter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Parameter::valueChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Parameter::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Parameter::propertyChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Parameter::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Parameter::changedFlagChanged)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject cedar::aux::Parameter::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_cedar__aux__Parameter.data,
    qt_meta_data_cedar__aux__Parameter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *cedar::aux::Parameter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "cedar::aux::IntrusivePtrBase"))
        return static_cast< cedar::aux::IntrusivePtrBase*>(this);
