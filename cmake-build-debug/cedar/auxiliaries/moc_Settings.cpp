...
void cedar::aux::Settings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Settings::currentArchitectureFileChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject cedar::aux::Settings::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_cedar__aux__Settings.data,
    qt_meta_data_cedar__aux__Settings,
    qt_static_metacall,
    nullptr,
    nullptr
} };
