...
void cedar::aux::gui::EnumParameter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<EnumParameter *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject cedar::aux::gui::EnumParameter::staticMetaObject = { {
    &cedar::aux::gui::Parameter::staticMetaObject,
    qt_meta_stringdata_cedar__aux__gui__EnumParameter.data,
    qt_meta_data_cedar__aux__gui__EnumParameter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
