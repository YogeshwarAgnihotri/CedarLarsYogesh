...
void cedar::aux::gui::LocalCoordinateFrameWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<LocalCoordinateFrameWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject cedar::aux::gui::LocalCoordinateFrameWidget::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_cedar__aux__gui__LocalCoordinateFrameWidget.data,
    qt_meta_data_cedar__aux__gui__LocalCoordinateFrameWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
