...
void cedar::aux::gui::detail::Qt5SurfacePlotWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Qt5SurfacePlotWorker *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (Qt5SurfacePlotWorker::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Qt5SurfacePlotWorker::done)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject cedar::aux::gui::detail::Qt5SurfacePlotWorker::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_cedar__aux__gui__detail__Qt5SurfacePlotWorker.data,
    qt_meta_data_cedar__aux__gui__detail__Qt5SurfacePlotWorker,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Qt5SurfacePlot *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Qt5SurfacePlot::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Qt5SurfacePlot::convert)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject cedar::aux::gui::Qt5SurfacePlot::staticMetaObject = { {
    &PlotInterface::staticMetaObject,
    qt_meta_stringdata_cedar__aux__gui__Qt5SurfacePlot.data,
    qt_meta_data_cedar__aux__gui__Qt5SurfacePlot,
    qt_static_metacall,
    nullptr,
    nullptr
} };
