...
void cedar::aux::gui::PluginInfoDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PluginInfoDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject cedar::aux::gui::PluginInfoDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_cedar__aux__gui__PluginInfoDialog.data,
    qt_meta_data_cedar__aux__gui__PluginInfoDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *cedar::aux::gui::PluginInfoDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui_PluginInfoDialog"))
        return static_cast< Ui_PluginInfoDialog*>(this);
