...
void cedar::aux::gui::AccelerationParameter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AccelerationParameter *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject cedar::aux::gui::AccelerationParameter::staticMetaObject = { {
    &cedar::aux::gui::NumericParameter<cedar::unit::Acceleration,QDoubleSpinBox>::staticMetaObject,
    qt_meta_stringdata_cedar__aux__gui__AccelerationParameter.data,
    qt_meta_data_cedar__aux__gui__AccelerationParameter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
