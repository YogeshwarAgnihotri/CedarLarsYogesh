...
void cedar::aux::gui::TimeParameter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TimeParameter *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject cedar::aux::gui::TimeParameter::staticMetaObject = { {
    &cedar::aux::gui::NumericParameter<cedar::unit::Time,QDoubleSpinBox>::staticMetaObject,
    qt_meta_stringdata_cedar__aux__gui__TimeParameter.data,
    qt_meta_data_cedar__aux__gui__TimeParameter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
