...
void cedar::aux::gui::VelocityParameter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<VelocityParameter *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject cedar::aux::gui::VelocityParameter::staticMetaObject = { {
    &cedar::aux::gui::NumericParameter<cedar::unit::Velocity,QDoubleSpinBox>::staticMetaObject,
    qt_meta_stringdata_cedar__aux__gui__VelocityParameter.data,
    qt_meta_data_cedar__aux__gui__VelocityParameter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
