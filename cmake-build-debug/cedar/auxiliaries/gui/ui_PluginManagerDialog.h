...
public:
    ...
    {
        PluginManagerDialog->setWindowTitle(QApplication::translate("PluginManagerDialog", "Plugin Manager", nullptr));
        QTableWidgetItem *___qtablewidgetitem = mpPluginList->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("PluginManagerDialog", "startup", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = mpPluginList->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("PluginManagerDialog", "loaded", nullptr));
        QTableWidgetItem *___qtablewidgetitem2 = mpPluginList->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("PluginManagerDialog", "name", nullptr));
        QTableWidgetItem *___qtablewidgetitem3 = mpPluginList->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("PluginManagerDialog", "path", nullptr));
        mpAddPluginBtn->setText(QApplication::translate("PluginManagerDialog", "add...", nullptr));
        mpLoadSelectedPluginsBtn->setText(QApplication::translate("PluginManagerDialog", "load", nullptr));
        mpSelectedPluginInfo->setText(QApplication::translate("PluginManagerDialog", "info", nullptr));
        mpDeleteButton->setText(QApplication::translate("PluginManagerDialog", "remove", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("PluginManagerDialog", "plugins", nullptr));
        mpAddPathBtn->setText(QApplication::translate("PluginManagerDialog", "add...", nullptr));
        mpUpButton->setText(QApplication::translate("PluginManagerDialog", "up", nullptr));
        mpDownBtn->setText(QApplication::translate("PluginManagerDialog", "down", nullptr));
#ifndef QT_NO_TOOLTIP
        mpHelpBtn->setToolTip(QApplication::translate("PluginManagerDialog", "<html><head/><body><p>Add paths for finding your plugins here. These paths will be searched according to a certain pattern, i.e., the name of the plugin as well as a 'build' path will automatically be appended.</p><p><br/>Example: suppose your plugin is in ~/workspace/Plugin/build/libPlugin.so. Here it is enough to specify the path ~/workspace; the manager will automatically append Plugin and build.</p></body></html>", nullptr));
#endif // QT_NO_TOOLTIP
        mpHelpBtn->setText(QApplication::translate("PluginManagerDialog", "?", nullptr));
        mpRemoveSearchPathBtn->setText(QApplication::translate("PluginManagerDialog", "remove", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("PluginManagerDialog", "search directories", nullptr));
    } // retranslateUi
