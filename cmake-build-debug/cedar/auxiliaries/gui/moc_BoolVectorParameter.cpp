...
void cedar::aux::gui::BoolVectorParameter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<BoolVectorParameter *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject cedar::aux::gui::BoolVectorParameter::staticMetaObject = { {
    &cedar::aux::gui::VectorParameter<bool,QCheckBox>::staticMetaObject,
    qt_meta_stringdata_cedar__aux__gui__BoolVectorParameter.data,
    qt_meta_data_cedar__aux__gui__BoolVectorParameter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
