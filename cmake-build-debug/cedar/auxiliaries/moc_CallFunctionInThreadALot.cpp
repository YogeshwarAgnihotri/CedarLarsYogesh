...
void cedar::aux::CallFunctionInThreadALot::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CallFunctionInThreadALot *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (CallFunctionInThreadALot::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CallFunctionInThreadALot::executeSignal)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject cedar::aux::CallFunctionInThreadALot::staticMetaObject = { {
    &cedar::aux::ThreadWrapper::staticMetaObject,
    qt_meta_stringdata_cedar__aux__CallFunctionInThreadALot.data,
    qt_meta_data_cedar__aux__CallFunctionInThreadALot,
    qt_static_metacall,
    nullptr,
    nullptr
} };
