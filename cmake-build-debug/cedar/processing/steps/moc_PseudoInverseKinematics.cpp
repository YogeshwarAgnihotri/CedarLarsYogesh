...
void cedar::proc::steps::PseudoInverseKinematics::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PseudoInverseKinematics *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject cedar::proc::steps::PseudoInverseKinematics::staticMetaObject = { {
    &cedar::proc::Step::staticMetaObject,
    qt_meta_stringdata_cedar__proc__steps__PseudoInverseKinematics.data,
    qt_meta_data_cedar__proc__steps__PseudoInverseKinematics,
    qt_static_metacall,
    nullptr,
    nullptr
} };
