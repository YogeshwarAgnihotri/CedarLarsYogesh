...
void cedar::proc::steps::UnitConverter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<UnitConverter *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject cedar::proc::steps::UnitConverter::staticMetaObject = { {
    &cedar::proc::Step::staticMetaObject,
    qt_meta_stringdata_cedar__proc__steps__UnitConverter.data,
    qt_meta_data_cedar__proc__steps__UnitConverter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
