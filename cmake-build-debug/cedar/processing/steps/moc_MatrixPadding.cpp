...
void cedar::proc::steps::MatrixPadding::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MatrixPadding *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject cedar::proc::steps::MatrixPadding::staticMetaObject = { {
    &cedar::proc::Step::staticMetaObject,
    qt_meta_stringdata_cedar__proc__steps__MatrixPadding.data,
    qt_meta_data_cedar__proc__steps__MatrixPadding,
    qt_static_metacall,
    nullptr,
    nullptr
} };
