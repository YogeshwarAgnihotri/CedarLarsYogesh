...
void cedar::proc::gui::BoostControl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<BoostControl *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject cedar::proc::gui::BoostControl::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_cedar__proc__gui__BoostControl.data,
    qt_meta_data_cedar__proc__gui__BoostControl,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *cedar::proc::gui::BoostControl::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui_BoostControl"))
        return static_cast< Ui_BoostControl*>(this);
