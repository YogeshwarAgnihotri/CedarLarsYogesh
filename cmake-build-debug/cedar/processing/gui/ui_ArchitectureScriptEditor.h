...
public:
    ...
    {
        ArchitectureScriptEditor->setWindowTitle(QApplication::translate("ArchitectureScriptEditor", "Architecture Script Editor", nullptr));
        mpAddButton->setText(QApplication::translate("ArchitectureScriptEditor", "add", nullptr));
        mpRemoveButton->setText(QString());
        QTableWidgetItem *___qtablewidgetitem = mpScriptList->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("ArchitectureScriptEditor", "name", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = mpScriptList->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("ArchitectureScriptEditor", "controls", nullptr));
        QTableWidgetItem *___qtablewidgetitem2 = mpScriptList->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("ArchitectureScriptEditor", "status", nullptr));
        QTableWidgetItem *___qtablewidgetitem3 = mpScriptList->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("ArchitectureScriptEditor", "type", nullptr));
    } // retranslateUi
