...
void cedar::proc::gui::ElementTreeWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ElementTreeWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (ElementTreeWidget::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ElementTreeWidget::elementAddedSignal)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ElementTreeWidget::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ElementTreeWidget::elementRemovedSignal)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (ElementTreeWidget::*)(QTreeWidgetItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ElementTreeWidget::elementNameChanged)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject cedar::proc::gui::ElementTreeWidget::staticMetaObject = { {
    &QTreeWidget::staticMetaObject,
    qt_meta_stringdata_cedar__proc__gui__ElementTreeWidget.data,
    qt_meta_data_cedar__proc__gui__ElementTreeWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
