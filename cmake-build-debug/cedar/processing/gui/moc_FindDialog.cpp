...
QT_INIT_METAOBJECT const QMetaObject cedar::proc::gui::FindDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_cedar__proc__gui__FindDialog.data,
    qt_meta_data_cedar__proc__gui__FindDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *cedar::proc::gui::FindDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui_FindDialog"))
        return static_cast< Ui_FindDialog*>(this);
