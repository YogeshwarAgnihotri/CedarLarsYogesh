...
void cedar::proc::gui::DataSlotItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DataSlotItem *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (DataSlotItem::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DataSlotItem::connectionValidityChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject cedar::proc::gui::DataSlotItem::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_cedar__proc__gui__DataSlotItem.data,
    qt_meta_data_cedar__proc__gui__DataSlotItem,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *cedar::proc::gui::DataSlotItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "cedar::proc::gui::GraphicsBase"))
        return static_cast< cedar::proc::gui::GraphicsBase*>(this);
