...
void cedar::proc::gui::ToolBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ToolBox::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ToolBox::selectionChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject cedar::proc::gui::ToolBox::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_cedar__proc__gui__ToolBox.data,
    qt_meta_data_cedar__proc__gui__ToolBox,
    qt_static_metacall,
    nullptr,
    nullptr
} };
