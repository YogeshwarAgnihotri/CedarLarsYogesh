...
void cedar::proc::gui::ProjectionMappingParameter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ProjectionMappingParameter *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject cedar::proc::gui::ProjectionMappingParameter::staticMetaObject = { {
    &cedar::aux::gui::Parameter::staticMetaObject,
    qt_meta_stringdata_cedar__proc__gui__ProjectionMappingParameter.data,
    qt_meta_data_cedar__proc__gui__ProjectionMappingParameter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
