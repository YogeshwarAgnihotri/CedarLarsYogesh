...
void cedar::proc::gui::ArchitectureWidgetList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ArchitectureWidgetList *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject cedar::proc::gui::ArchitectureWidgetList::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_cedar__proc__gui__ArchitectureWidgetList.data,
    qt_meta_data_cedar__proc__gui__ArchitectureWidgetList,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *cedar::proc::gui::ArchitectureWidgetList::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui_ArchitectureWidgetEditor"))
        return static_cast< Ui_ArchitectureWidgetEditor*>(this);
